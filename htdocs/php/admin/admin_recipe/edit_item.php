...
<html>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" />
     ...
     <link rel="stylesheet" href="../../user/user_css/recipe_form.css">
     <script>
    function leave_confirmation()
    {
     ...
     function leave_confirmation2()
    {
      if (confirm("Are you sure you want to cancel?"))
        window.location.href="display_recipe.php";
    }
...
<div id="formular">
  ...
  <button id="cancel"  <?php 
    session_start();
    if($_SESSION['username']!=$row['username'])
      echo 'onclick="leave_confirmation2()"';
    else
      echo 'onclick="leave_confirmation()"';
  ?>>Cancel</button> 
